...
const PATHS: Record<string, string> = {
  ...
  chat: "M21 11.5a8.4 8.4 0 0 1-1 4 8.5 8.5 0 0 1-7.5 4.5 8.4 8.4 0 0 1-4-1L3 20l1-4.5a8.4 8.4 0 0 1-1-4A8.5 8.5 0 0 1 7.5 4a8.4 8.4 0 0 1 4-1H12a8.5 8.5 0 0 1 9 8.5Z",
};
